...
|---|---|---|
| 0 | リポジトリ基盤・ビルド構成 | 完了 |
| 1 | Core（ID / 矩形 / 入力 / 状態保持 / アニメーション） | 未着手 |
| 2 | Render（描画プリミティブ・テキスト） | 未着手 |
| 3 | Theme（デザイントークン・既定テーマ） | 未着手 |
| 4 | Layout（レイアウトエンジン・コンテナ） | 未着手 |
| 5 | Widgets 第1陣（基本ウィジェット） | 未着手 |
| 6 | Windowing（独自ウィンドウ基盤） | 未着手 |
| 7 | Widgets 第2陣（入力系・一覧系） | 未着手 |
| 8 | Fluent / Binding（宣言的 API・設定バインディング） | 未着手 |
